...
2. [ログインの方法](#login)
3. [ログアウトの方法](#logout)
4. [タイムカードに記録する方法](#record)
5. [開始時刻を打刻する](#start)
6. [終了時刻を打刻する](#finish)
7. [休憩時刻を打刻する](#rest)
8. [フォーム入力の際の注意点](#form)
9. [休憩終了時刻を打刻する](#restfinish)
...
## <a id="restfinish">休憩終了時刻を打刻する方法</a>
